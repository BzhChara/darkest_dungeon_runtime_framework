...
- Realtime hard enforcement is still incomplete outside the quest board: stage coach recruits and pre-finale hero/trinket availability policies need schema-verified live save mutation or runtime hooks after week settlement and party selection changes.
