...
Research sample scan: `logs/research_save_samples/saveeditor_samples_20260608_234420.json`, generated by `tools/InspectResearchSaveSamples.ps1`, processes all 13 SaveEditor v0.0.70 test resource directories and 80 JSON files. See `docs/research_save_samples.md`.
